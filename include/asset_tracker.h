...
// Payload size increased for AWS IoT Core Device Location compatibility
// AWS IoT Core Device Location service handles larger payloads natively
#define MAX_PAYLOAD_SIZE 255                    // Maximum payload size for Sidewalk with AWS IoT Core Device Location
...
// Updated for AWS IoT Core Device Location - increased limits
#define MAX_WIFI_NB ( 32 )    // Max number of WiFi APs to send (increased from 8)
#define MAX_GNSS_SIZE (512)   // Max size of GNSS nav buffer (increased from 300)
#define GNSS_DEBUG
...
// Updated header size for simplified payload structure
...
typedef struct at_context {
        ...
        bool motion;
        // Removed fragmentation tracking - AWS IoT Core handles this natively
